<p align="center">
  <img src="images/logo-seastar-haproxy.png" alt="Seastar HAProxy logo" width="80%">
</p>
...
<p align="center">
  <img src="images/how-it-works.svg" alt="How the agent answers ip_bad: HAProxy sends the client IP, pipelining, database lookup, category match, AGENT-ACK, then allow or tarpit">
</p>

<details>
<summary>Show the Mermaid diagram (light theme)</summary>
...
<p align="center">
  <img src="images/architecture-docker.svg" alt="Docker Compose deployment: HAProxy container, agent container, shared proxy network, data volume and FireHOL updates">
</p>
...
<p align="center">
  <img src="images/agent-internals.svg" alt="SPOA agent internals: Seastar reactors per core, helper threads, watcher and job scheduler threads">
</p>
...
<p align="center">
  <img src="images/lifecycle.svg" alt="Startup, hourly update and shutdown lifecycle of the agent">
</p>
...
<p align="center">
  <img src="images/request-decision.svg" alt="HTTP request and IP reputation decision flow with the SPOA agent and decision cache">
</p>
...
<p align="center">
  <img src="images/request-sequence.svg" alt="SPOE request sequence: HAProxy, decision cache, agent and reputation database">
</p>
...
<p align="center">
  <img src="images/benchmark.svg" alt="SPOE benchmark architecture inside the benchmark container">
</p>
